...
public class Handler implements Reader {
    ...
    private List<Player> player;    //ELENCO PLAYER
    private static List<Tiles> tiles; //ELENCO TILES (DA MODIFICARE PER CREAZIONE DI SCENARI PIU COMPLESSI)
    private static List<Enemy> enemy; //ELENCO TILES (DA MODIFICARE PER CREAZIONE DI SCENARI PIU COMPLESSI)
    ...
    public Handler(SuperMario mario) {
        ...
        Bullet.bullet = MemoriaAC.getBullet();
...
//        MemoriaAC.clean();
        MemoriaAC.carica();
        //MemoriaAC.adaptImage(SuperMario.standardWidth, SuperMario.standardHeight);
                ...
                switch (type) {
                    case "UNLOCKED":
                        tiles.add(new Solid(x0, y0, SuperMario.standardWidth, SuperMario.standardHeight, this,
                                type, MemoriaAC.getUnlockable(), true, tile, false, movement));   //SE E NERO E' NORMALE SOLIDO
                        break;
                    case "UNLOCKABLE":
                    case "SOLID":
                        tiles.add(new Solid(x0, y0, SuperMario.standardWidth, SuperMario.standardHeight, this,
                                type, MemoriaAC.getTiles(), true, tile, false, movement));   //SE E NERO E' NORMALE SOLIDO
                        break;
                    //case "UNLOCKED":
                    //tiles.add(new Solid(x0, y0, SuperMario.standardWidth, SuperMario.standardHeight, this, type, MemoriaAC.getUnlockable(), true, tile, false, unlockable));
                    //break;
                    case "CRASH":
                    case "PLAYER_LUIGI":
                    ...
                    case "UP1":
                        tiles.add(new Solid(x0, y0, SuperMario.standardWidth, SuperMario.standardHeight, this,
                                type, MemoriaAC.getUnlockable(), false, tile, false, movement)); //SE E GIALLO E' UNA MONETA
                        break;
                    ...
                    case "SPINE":
                        tiles.add(new Solid(x0, y0, SuperMario.standardWidth, SuperMario.standardHeight, this,
                                type, MemoriaAC.getTiles(), true, tile, true, movement));
                        break;
                    case "TARTOSSO":
                    ...
                    case "TUBO_RED_DOWN":
                        tiles.add(new Solid(x0, y0 - SuperMario.standardHeight, SuperMario.standardWidth * 2, SuperMario.standardHeight * 2,
                                this, type, MemoriaAC.getTiles(), true, tile, false, movement));
                        break;
                    case "PIRANHAPLANT":
                    ...
                    case "CHECKPOINT":
                        tiles.add(new Checkpoint(x0, y0 - SuperMario.standardHeight, SuperMario.standardWidth * 2, SuperMario.standardHeight * 2,
                                this, type, MemoriaAC.getUnlockable(), false, tile, movement));   //SE E NERO E' NORMALE SOLIDO
                        break;
                    case "VOID":
                        tiles.add(new Checkpoint(x0, y0, SuperMario.standardWidth, SuperMario.standardHeight, this,
                                type, MemoriaAC.getTiles(), true, tile, movement));   //SE E NERO E' NORMALE SOLIDO
                        break;
                    case "CHAINCHOMP":
                    ...
                    case "FLAG":
                        tiles.add(new Checkpoint(x0, y0, SuperMario.standardWidth, SuperMario.standardHeight, this,
                                type, MemoriaAC.getUnlockable(), false, tile, movement));   //SE E NERO E' NORMALE SOLIDO
                        break;
                    case "ROD":
                    ...
                    case "MUSHROOMPLATFORM":
                        /*tiles.add(new Solid(x0, y0, SuperMario.standardWidth, SuperMario.standardHeight, this,
                                type, true, tile, movement));*/   //SE E NERO E' NORMALE SOLIDO
                        tiles.add(new Solid(x0, y0, SuperMario.standardWidth, SuperMario.standardHeight, this,
                                type, MemoriaAC.getTerreni(), true, tile, false, movement));
                        break;
                    case "CANNONE":
